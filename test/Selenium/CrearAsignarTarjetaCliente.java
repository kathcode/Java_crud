...
public class CrearAsignarTarjetaCliente {
    ...
    public void CrearTarjetaPruebasFuncionales() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ListarTarjeta")));
        WebElement link5 = driver.findElement(By.id("ListarTarjeta"));
        link5.click();
         try {
            Thread.sleep(4000);
        } catch (InterruptedException ex) {
