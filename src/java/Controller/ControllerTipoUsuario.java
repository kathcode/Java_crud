...
public class ControllerTipoUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(option != null)
        {
            ...
            if(option.equals("listarTipoUsuarios"))
            {
                ListTypeUsers(request, response);
            }
    ...
    private void ListTypeUsers(HttpServletRequest request, HttpServletResponse response) {
        
        try {
            DAOTipoUsuario dao = new DAOTipoUsuario();
            List<ModelTipousuario> listTypeUser = dao.ListTypeUser();
