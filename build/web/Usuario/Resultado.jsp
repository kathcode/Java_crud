<%-- 
    Document   : Resultado
    Created on : Oct 8, 2017, 11:03:03 PM
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <a href="Usuario/Crear.jsp" class="btn btn-primary pull-right">Crear nuevo usuario</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody> 
                                    ...
                                    <%
                                        ...
                                        for (ModelUsuario u : listaUsuario) {
                                            ...
                                            out.println("<td><a href= 'Usuario?opcion=detail&idUsuario=" + u.getId_Usuario() + "'> <span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span> Ver </a> "
